...
<main id="main">    
                ...
                <!-- Home section -->
                <section class="home-section parallax-5 bg-dark-alfa-90" data-background="https://wallpaperaccess.com/full/712353.jpg" id="home">
                    ...
                    <div class="fullwidth-slider owl-carousel">
                        ...
                        <div class="container min-height-100vh d-flex align-items-center pt-100 pb-100">
                            ...
                            <div class="home-content">
                                <h1 class="hs-line-4 mb-30 mb-xs-20 owl-animate-1">%100 Vac ban korumalı tek yazılım</h1>
                                <h2 class="hs-line-7 mb-60 mb-xs-40 owl-animate-2 owl-delay-450">Inside Yazılım</h2>
                                <div class="local-scroll mb-20 owl-animate-3 owl-delay-700">
                                    <a href="#about" class="btn btn-mod btn-w btn-medium btn-round mx-md-1">Fiyat Listesi</a>
                                    <a href="pages-contact-1-dark-1.html" class="btn btn-mod btn-w btn-medium btn-round mx-md-1">Kayıt Ol</a>
                                </div>
                            </div>
                            <!-- End Hero Content -->   
                        ...
                        <div class="container min-height-100vh d-flex align-items-center pt-100 pb-100">  
                            ...
                            <!-- Hero Content -->
                            <div class="home-content">
                                <h1 class="hs-line-4 mb-30 mb-xs-20 owl-animate-1">Get the new experience with</h1>
                                <h2 class="hs-line-7 mb-60 mb-xs-40 owl-animate-2 owl-delay-500">Creative Design Agency</h2>
                                <div class="local-scroll mb-20 owl-animate-3 owl-delay-750">
                                    <a href="#about" class="btn btn-mod btn-medium btn-round mx-md-1">See More</a>
                                    <a href="../watch.html?v=jTea_8Fk5Ns" class="btn btn-mod btn-medium btn-round mx-md-1 lightbox mfp-iframe">Play Reel</a>
                                </div>
                            </div>
                            <!-- End Hero Content -->
                        ...
                        <div class="container min-height-100vh d-flex align-items-center pt-100 pb-100">
                            ...
                            <!-- Hero Content -->
                            <div class="home-content">
                                <h1 class="hs-line-4 mb-30 mb-xs-20 owl-animate-1">Create Your Dream</h1>
                                <h2 class="hs-line-7 mb-60 mb-xs-40 owl-animate-2 owl-delay-500">With Amazing Design</h2>
                                <div class="local-scroll mb-20 owl-animate-3 owl-delay-750">
                                    <a href="pages-pricing-1-dark-1.html" class="btn btn-mod btn-medium btn-round mx-md-1">Get Pricing</a>
                                </div>
                            </div>
                            <!-- End Hero Content -->
                                    ...
                                    <div class="count-item">
                                        ...
                                        <div class="relative wow fadeIn" data-wow-delay="1s">
                                            ...
                                            <i class="fas fa-users"></i>
                                                <span class="count-title">Müşteri</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="count-item">
                                        ...
                                        <div class="relative wow fadeIn" data-wow-delay="1.1s">
                                            ...
                                            <i class="fas fa-gifts"></i>
                                                <span class="count-title">Hediye Gün</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="count-item">
                                        ...
                                        <div class="relative wow fadeIn" data-wow-delay="1.2s">
                                            ...
                                            <i class="fas fa-ticket-alt"></i>
                                                <span class="count-title">Talep Cevapladık</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="count-item">
                                        ...
                                        <div class="relative wow fadeIn" data-wow-delay="1.3s">
                                            ...
                                            <i class="fas fa-gamepad"></i>
                                                <span class="count-title">Oyunda</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-140 mt-lg-80 mt-md-60 mt-xs-30 mb-140 mb-lg-80">
                                    <div class="banner-content wow fadeInUpShort" data-wow-duration="1.2s">
                                        ...
                                        <div class="local-scroll">
                                            <a href="pages-services-1-dark-1.html" class="btn btn-mod btn-w btn-large btn-round">View Services</a>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
                            ...
                            <div class="container relative">
                                <div class="row wow fadeInUpShort">
                                    ...
                                    <div class="col-lg-3 pt-10 text-lg-end">
                                        <div class="local-scroll">
                                            <a href="portfolio-wide-gutter-3col-dark.html" class="btn btn-mod btn-w btn-large btn-round">View Portfolio</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container relative">
                        <div class="row">
                            ...
                            <div class="col-lg-5 wow fadeInUpShort" data-wow-duration="1.2s" data-wow-offset="255">
                                ...
                                <div class="local-scroll">
                                    <a href="pages-contact-1-dark-1.html" class="btn btn-mod btn-w btn-large btn-round">Start Project</a>
                                </div>
                        ...
                        <div class="text-center mb-80 mb-sm-50">
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-sm-end pt-30 pt-xs-0">
                                    <a href="shop-columns-3col-dark.html" class="section-more">Our Shop <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="images/shop/shop-prev-1.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s"></a>
                                    <div class="intro-label">
                                        <span class="badge badge-danger bg-red">Sale</span>
                                    </div>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                                    <a href="shop-single-dark.html">Polo Applique Jersey</a>
                                </div>
                                ...
                                <div class="post-prev-more text-center">
                                    <a href="#" class="btn btn-mod btn-w btn-round"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                </div>
                            </div>
                            <!-- End Shop Item -->
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="images/shop/shop-prev-2.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s"></a>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                                    <a href="shop-single-dark.html">Pique Polo Shirt</a>
                                </div>
                                <div class="post-prev-text text-center">
                                    <strong>$28.99</strong>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="images/shop/shop-prev-3.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s"></a>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3 mb-md-50">
                                <div class="post-prev-img">
                                    <a href="shop-single-dark.html" tabindex="-1"><img src="images/shop/shop-prev-4.jpg" alt="" class="wow scaleOutIn" data-wow-duration="1.2s"></a>
                                </div>
                                <div class="post-prev-title text-center mb-10">
                                    <a href="shop-single-dark.html">Shirt Floral Sleeves</a>
                                </div>
                                <div class="post-prev-text text-center">
                                    <strong>$85.99</strong>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-lg-4 pb-20">
                                        <div class="contact-item wow fadeScaleIn" data-wow-delay=".1s" data-wow-duration="1s">
                                            ...
                                            <div class="ci-link">
                                                <a href="../maps/place/245 Quigley Blvd Ste K, New Castle, DE 19720, USA/@39.6599303,-75.6048019,17z/data=!3m1!4b1!4m5!3m4!1s0x89c703f3d191cf130xf4674106f987fe3a!8m2!3d39.6599303!4d-75.6026132.html" target="_blank">See on the Map</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Address -->
                                    ...
                                    <div class="col-sm-6 col-lg-4 pb-20">
                                        <div class="contact-item wow fadeScaleIn" data-wow-delay=".2s" data-wow-duration="1s">
                                            ...
                                            <div class="ci-text">
                                                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dfacaaafafb0adab9fbdbaacabb3b0b0b4baadf1afadb0">[email&#160;protected]</a>
                                            </div>
                                            <div class="ci-link">
                                                <a href="/cdn-cgi/l/email-protection#f685838686998482b6949385829a99999d9384d8868499">Say Hello</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Email -->
                    ...
                    <div class="container relative">
                        <div class="row wow fadeInUpShort">
                            <div class="col-md-8 offset-md-2 text-center">
                                ...
                                <div class="local-scroll">
                                    <a href="pages-contact-1-dark-1.html" class="btn btn-mod btn-w btn-large btn-round">Let's Talk</a>
                                </div>
                            </div>
                        </div>
                    </div>
